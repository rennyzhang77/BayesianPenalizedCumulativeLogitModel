---
title: "Bayesian Variable Selection: Model 3 with Beta(1,19) prior"
...
### Proposed Bayesian Model III with Beta(1, 19) prior for pi
model3<- function(){
  for(i in 1:N){
...
nIter <- ceiling((numSavedSteps*thinSteps )/nChains) 	#steps per chain
  ...
  start.time.3.beta.1.19 <- Sys.time()
...
### select variable using bayes factor based on gamma
 ...
 save.image("Model3Beta1_19BMC.RData")
  stopCluster(cl)
  RSessionInfo()
```
