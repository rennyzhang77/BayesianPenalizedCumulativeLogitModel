---
title: "Bayesian Variable Selection: Model 4 Fixed Prior 0.05"
...
### Proposed Bayesian Model IV with pi fixed at 0.05
model4<- function(){
  for(i in 1:N){
...
nIter <- ceiling((numSavedSteps*thinSteps )/nChains) 	#steps per chain
  ...
  end.time.4.pi.05 <- Sys.time()
  save.image("Model4FixedPi05.RData")
...
save.image("Model4FixedPi05BMC.RData")
stopCluster(cl)
```
