---
title: "Bayesian Variable Selection: Model 2 with Beta(1,19) prior"
...
### Proposed Bayesian Model II with Beta(1, 19) prior for pi
model2 <- function(){
  for(i in 1:N){
...
start.time.2.beta.1.19 <- Sys.time() 
...
save.image("Model2Beta1_19BMC.RData")
stopCluster(cl)
```
