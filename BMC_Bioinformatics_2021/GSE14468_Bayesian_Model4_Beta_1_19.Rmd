---
title: "Bayesian Variable Selection: Model 4 with Beta(1,19) Prior"
...
### Proposed Bayesian Model IV with Beta(1, 19) prior for pi
model4<- function(){
  for(i in 1:N){
...
nIter <- ceiling((numSavedSteps*thinSteps )/nChains) 	#steps per chain
  ...
  start.time.4.beta.1.19 <- Sys.time()
...
save.image("Model4Beta1_19BMC.RData")
stopCluster(cl)
```
