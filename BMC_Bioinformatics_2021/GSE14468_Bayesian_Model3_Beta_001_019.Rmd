---
title: "Bayesian Variable Selection: Model 3 with Beta(0.01,0.19) prior"
...
### Proposed Bayesian Model III with Beta(0.01, 0.19) prior for pi
model3<- function(){
  for(i in 1:N){
...
nIter <- ceiling((numSavedSteps*thinSteps )/nChains) 	#steps per chain
  ...
  start.time.3.beta.001.019 <- Sys.time()
...
end.time.3.beta.001.019 <- Sys.time()
...
save.image("Model3Beta001_019BMC.RData")
stopCluster(cl)
RSessionInfo()
```
