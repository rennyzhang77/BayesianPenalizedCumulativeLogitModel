---
title: "Bayesian Variable Selection: Model 4 Fixed prior 0.50"
...
### Proposed Bayesian Model IV with pi fixed at 0.50
model4<- function(){
  for(i in 1:N){
...
nIter <- ceiling((numSavedSteps*thinSteps )/nChains) 	#steps per chain
  ...
  end.time.4.pi.50 <- Sys.time()
  save.image("Model4FixedPi50.RData")
...
save.image("Model4FixedPi50BMC.RData")
stopCluster(cl)
```
