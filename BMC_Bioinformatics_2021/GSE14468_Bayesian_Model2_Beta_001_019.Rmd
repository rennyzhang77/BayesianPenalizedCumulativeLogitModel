---
title: "Bayesian Variable Selection: Model 2 with Beta(0.01,0.19) prior"
...
### Proposed Bayesian Model II with Beta(0.01, 0.19) prior for pi
model2 <- function(){
  for(i in 1:N){
...
start.time.2.beta.001.019 <- Sys.time() 
...
end.time.2.beta.001.019 <- Sys.time()
...
### select variable using bayes factor based on gamma
 ...
 save.image("Model2Beta001_019BMC.RData")
  stopCluster(cl)
```
